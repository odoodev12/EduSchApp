<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatedAdminRoleReport.aspx.cs" Inherits="SchoolApp.Web.Reports.CreatedAdminRoleReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Created Admin Role Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("strCreatedDate") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("RoleName") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("strCreateBy") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("ActivatedFunctions") %></td>
                                                </tr>
                                            </ItemTemplate>
                                            <LayoutTemplate>
                                                <tr runat="server">
