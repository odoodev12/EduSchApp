<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstLoginPage.aspx.cs" Inherits="SchoolApp.Web.FirstLoginPage" %>
...
<head>
    ...
    <!-- Title -->
    <title>First time set password</title>
                                ...
                                <asp:UpdatePanel ID="MainUpdatePanel" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="input-group m-b">
                                            ...
                                            <asp:TextBox ID="txtPassword" AutoCompleteType="Disabled" required="" placeholder="New Password" TextMode="Password" CssClass="form-control" runat="server"></asp:TextBox>
                                            <asp:RegularExpressionValidator ControlToValidate="txtPassword" ValidationGroup="Submit" ID="RegularExpressionValidator2" runat="server" ErrorMessage="<a class='ourtooltip'><i class='fa fa-exclamation-circle'></i><span><b></b>Password must be 6 characters long with Alphanumeric only,</br> no special character allowed.</span></a>" ValidationExpression="\b[a-zA-Z0-9]{6,50}\b"></asp:RegularExpressionValidator>
                                        ...
                                        <div class="input-group m-b">
                                            <%--<span class="input-group-addon"><i class="fa fa-key"></i></span>--%>
                                            <asp:TextBox ID="txtConfirmPassword" AutoCompleteType="Disabled" required="" placeholder="Confirm New Password" TextMode="Password" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <%--<div class="input-group m-b">--%>
                                            ...
                                            <%--<asp:DropDownList ID="drpMemorableQue" required="" placeholder="Select Memorable Question" CssClass="form-control" runat="server"></asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="Requiredfieldvalidator11" CssClass="alert validation" runat="server" ValidationGroup="Submit" ControlToValidate="drpMemorableQue" ErrorMessage="<a class='ourtooltip'><i class='fa fa-exclamation-circle'></i><span><b></b>Memorable Question Required</span></a>"></asp:RequiredFieldValidator>--%>
                                        <%--</div>--%>
                                        <div class="input-group m-b">
                                            <%--<span class="input-group-addon"><i class="fa fa-key"></i></span>--%>
