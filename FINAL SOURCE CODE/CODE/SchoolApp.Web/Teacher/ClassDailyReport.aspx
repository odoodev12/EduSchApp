<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClassDailyReport.aspx.cs" Inherits="SchoolApp.Web.Teacher.ClassDailyReport" %>
    ...
    <header class="inner">
        ...
        <div class="header-content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading"><asp:HyperLink ID="hlinkTeacher" runat="server" NavigateUrl="Home.aspx"><i class="fa fa-home"></i></asp:HyperLink> / <a href="classreport.aspx">Class Report</a> / <span>Class Daily Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <asp:ListView ID="ListView1" runat="server" OnPagePropertiesChanging="ListView1_PagePropertiesChanging" OnItemDataBound="ListView1_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="color_red" style="border-bottom: 1px solid #ddd"><%# Eval("PickStatus") %></td>
