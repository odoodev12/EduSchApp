<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClassStudents.aspx.cs" Inherits="SchoolApp.Web.School.ClassStudents" %>
                                            ...
                                            <div class="class-box feature">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 col-xs-8" style="padding-left: 0px;">
                                                        ...
                                                        <div class="buttons">
                                                            <asp:LinkButton ID="btnReAssign" runat="server" class="btn btn-primary" Visible='<%# Eval("ClassName").ToString() == "" +
                "Outside Class" ? false : true %>' data-toggle="modal" OnClientClick='<%# "return SetID("+Eval("ID")+")" %>' data-target="#reassign_class">Re-assign Class</asp:LinkButton>
                                                            <asp:Button ID="btnRemove" CommandName="btnRemove" CommandArgument='<%# Eval("ID") %>' runat="server" Visible='<%# Eval("ClassName").ToString() == "Outside Class" ? false : true %>' CausesValidation="false" CssClass="btn btn-danger" Text="Remove" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtStudentName" runat="server" class="form-control" BorderColor="Red" />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:CompareValidator runat="server" ID="CompareValidator1" ControlToValidate="txtPPEmai" ValidationGroup="Submit" ForeColor="Red" ControlToCompare="txtSPEmail" Operator="NotEqual" Type="String" ErrorMessage="Primary Email and Secondary Email cannot be the same" />
