<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminroleView.aspx.cs" Inherits="SchoolApp.Web.School.AdminroleView" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            <asp:HyperLink ID="hlinkSupportLog" runat="server" NavigateUrl="adminrole.aspx" Text="Custom Roles"></asp:HyperLink>
                            / <span>View</span></h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
						 ...
						 <asp:CheckBox ID="chkClass" runat="server" />
						  ...
						  <asp:CheckBox ID="chkstudent" runat="server" />
                                            ...
                                            <label class="checkbox_style">
                                                Can Manage Teacher
						  <asp:CheckBox ID="chkteacher" runat="server" />
                                                <span class="checkmark"></span>
                                                <div class="bot-border"></div>
                                            </label>
						  ...
						  <asp:CheckBox ID="chkNonTeacher" runat="server" />
                                                <span class="checkmark"></span>
                                                <div class="bot-border"></div>
                                            </label>
                                             <%}%>
						  ...
						  <asp:CheckBox ID="chksuppor" runat="server" />
                                                <span class="checkmark"></span>
                                                <div class="bot-border"></div>
                                            </label>
                                            <label class="checkbox_style">
						  ...
						  <asp:CheckBox ID="chkActive" runat="server" />
                                        ...
                                        <div class="col-md-12" style="margin-top: 10px;">
                                            <asp:Button ID="btnUpdate" OnClick="btnUpdate_Click" runat="server" class="btn btn-primary" Text="Update" />
                                        </div>
                                    </div>
                                </div>
                            </div>
