<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="SchoolApp.Admin.ResetPassword" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12 no-padding-left no-padding-right">
                                            <asp:Button ID="btnSubmit" class="btn btn-primary block full-width" ValidationGroup="Submit" runat="server" OnClick="btnSubmit_Click"  Text="Submit" />
                                        </div>
