<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AbsentStudentReport.aspx.cs" Inherits="SchoolApp.Web.Reports.AbsentStudentReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Absent Student Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                         <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="classyear">Student No</label>
                                        <div class="col-sm-9">
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="classyear">Student Name</label>
                                        <div class="col-sm-9">
                                        ...
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtStName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetsStudentss">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="studentname">Class Name</label>
                                        <div class="col-sm-9">
                                        ...
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassname"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetsClassess">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                    </div>
                                        ...
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("AttStatus") %></td>
