<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClubClass.aspx.cs" Inherits="SchoolApp.Web.School.ClubClass" %>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <h4 style="margin-top: 0px;">Class Type:
                                <asp:Literal ID="litClassYear" runat="server" Text="Club"></asp:Literal></h4>
