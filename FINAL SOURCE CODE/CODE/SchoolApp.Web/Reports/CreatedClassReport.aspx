<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatedClassReport.aspx.cs" Inherits="SchoolApp.Web.Reports.CreatedClassReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Created Class Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <asp:TextBox ID="txtClassName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteTeachers" runat="server" targetcontrolid="txtClassName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClasses">
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" for="studentname">Class Year</label>
                                        <div class="col-sm-9">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("CreatedDateTime", "{0:dd/MM/yyyy}") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("Name") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("YearName") %></td>
