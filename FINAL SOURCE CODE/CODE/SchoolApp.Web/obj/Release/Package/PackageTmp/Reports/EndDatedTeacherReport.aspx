<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EndDatedTeacherReport.aspx.cs" Inherits="SchoolApp.Web.Reports.EndDatedTeacherReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>EndDated Teacher Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                   <div class="row">
                            ...
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <asp:TextBox ID="txtTeacherNames" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteTeachers" runat="server" targetcontrolid="txtTeacherNames"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetAllTeachers">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="studentname">Class Year</label>
                                        <div class="col-sm-9">
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" for="classyear">Class Name</label>
                                        <div class="col-sm-9">
                    ...
                    <div class="row" style="text-align: center; margin-bottom: 15px;">
                        ...
                        <asp:Button ID="btnExport" runat="server" Text="Export to Excel" class="btn btn-primary" OnClick="btnExport_Click"></asp:Button>
                    </div>
                        <div class="row">
                            <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="classyear">Class Name</asp:Label>
                                        <asp:DropDownList runat="server" ID="drpClass" class="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                ...
                                <asp:Button ID="btnExport" runat="server" Text="Export to Excel" class="btn btn-primary btn-block" OnClick="btnExport_Click"></asp:Button>
                            </div>--%>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("TeacherEndDate") %></td>
                                            ...
                                            <LayoutTemplate>
                                                ...
                                                <tr runat="server">
                                                    <td runat="server">
                                                        <asp:DataPager runat="server" PageSize="10" ID="DataPager5">
                                                            <Fields>
