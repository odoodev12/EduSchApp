<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="SchoolApp.Admin.ForgotPassword" %>
...
<head runat="server">
    <title>SCHOOL APP : Forgot Password</title>
                                ...
                                <div class="panel-body">
                                    <div class="text-center">
                                        ...
                                        <h5 class="content-group">SCHOOL APP<br />
                                            ...
                                            <small class="display-block">Enter your correct email to proceed</small></h5>
                                    </div>
                                    <br />
                                    <br />
                                    ...
                                    <div class="input-group m-b">
                                        ...
                                        <asp:TextBox ID="txtUserName" required="" placeholder="Enter your email" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>                                    

                                    <asp:Panel ID="pnlInvalid" class="form-group text-center " Visible="false" runat="server">
                                        <span class="label label-danger">Oops! Invalid Email Entered</span>
                                    </asp:Panel>

                                    <div class="form-group ">
                                        <div class="col-sm-12 no-padding-left no-padding-right">
                                            <asp:Button ID="btnSubmit" class="btn btn-primary block full-width" runat="server" Text="Send Mail" OnClick="btnSubmit_Click" />
                                        </div>                                       
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <center><h4 class="modal-title">Invalid email address you entered</h4></center>
                                    <center><small class="font-bold">contact administrator to get your email</small></center>
                                </div>
                                <div class="modal-body">
                                    <p >Invalid email you entered, please contact your administrator get more details.</p>
