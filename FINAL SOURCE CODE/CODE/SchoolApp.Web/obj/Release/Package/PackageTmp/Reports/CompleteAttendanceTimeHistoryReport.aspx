<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CompleteAttendanceTimeHistoryReport.aspx.cs" Inherits="SchoolApp.Web.Reports.CompleteAttendanceTimeHistoryReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Complete Attendance Time History</span></h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="">Date:</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" type="date" ID="txtDate" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3"  for="studentname">Class Name</label>
                                        <div class="col-sm-9">
                                           <asp:TextBox ID="txtClassName" runat="server" class="form-control" placeholder="Enter Class Name" />
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassFuncss">
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server"  for="classyear">Activated By
                                        </label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtTeacherName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFuncs1">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="classyear">Activated By Name</asp:Label>
                                        <asp:TextBox ID="txtTeacherName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFuncs1">
                                        </ajax:autocompleteextender>
                                ...
                                <table class="table">
                                    <thead style="background: #232323; color: white;">
                                        <tr>
                                            <th>Date</th>
                                            <th>Class Name</th>
                                            <th>Complete Attendance Time</th>
                                            <th>Activated By</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("A_Date") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("ClassName") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("A_Time") %></td>
