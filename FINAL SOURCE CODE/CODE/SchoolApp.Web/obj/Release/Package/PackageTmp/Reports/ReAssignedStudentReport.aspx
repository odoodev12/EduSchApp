<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReAssignedStudentReport.aspx.cs" Inherits="SchoolApp.Web.Reports.ReAssignedStudentReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Student Reassign History Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtStName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetReStudent">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="studentname">Class From
                                        </label>
                                        <div class="col-sm-9">
                                        ...
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassFrom"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassFrom">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="Autocompleteextender2" runat="server" targetcontrolid="txtClassTo"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassTo">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("StudentNo") %></td>
