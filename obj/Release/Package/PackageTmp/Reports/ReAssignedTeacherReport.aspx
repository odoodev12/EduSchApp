<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReAssignedTeacherReport.aspx.cs" Inherits="SchoolApp.Web.Reports.ReAssignedTeacherReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Teacher Reassign History Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3"for="studentname">Class From</label>
                                        <div class="col-sm-9">
                                           <asp:TextBox ID="txtClassFrom" runat="server" class="form-control" placeholder="Enter Class From" />
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassFrom"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassFroms">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                             <asp:TextBox ID="txtStName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtStName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetReTeachers">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="studentname">Class To
                                        </label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtClassTo" runat="server" class="form-control" placeholder="Enter Class From" />
                                        <ajax:autocompleteextender id="Autocompleteextender2" runat="server" targetcontrolid="txtClassTo"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassTos">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="classyear">Teacher Name</asp:Label>
                                        <asp:TextBox ID="txtStName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtStName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetReTeachers">
                                        </ajax:autocompleteextender>
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="studentname">Class From</asp:Label>
                                        <asp:TextBox ID="txtClassFrom" runat="server" class="form-control" placeholder="Enter Class From" />
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassFrom"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassFroms">
                                        </ajax:autocompleteextender>
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="studentname">Class To</asp:Label>
                                        <asp:TextBox ID="txtClassTo" runat="server" class="form-control" placeholder="Enter Class From" />
                                        <ajax:autocompleteextender id="Autocompleteextender2" runat="server" targetcontrolid="txtClassTo"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassTos">
                                        </ajax:autocompleteextender>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("DateStr") %></td>
                                                <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("TeacherName") %></td>
                                                <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("ClassFrom") %></td>
                                                <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("ClassTo") %></td>
                                                <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("ReAssignedBy") %></td>
                                            </tr>
                                        </ItemTemplate>
                                        <LayoutTemplate>
                                            <tr runat="server">
