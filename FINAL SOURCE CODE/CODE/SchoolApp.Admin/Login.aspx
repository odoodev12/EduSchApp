<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SchoolApp.Admin.Login" %>
                            ...
                            <div class="ibox-content">
                                <div class="panel-body">
                                    ...
                                    <div class="input-group m-b">
                                        ...
                                        <asp:TextBox ID="txtUserName" required="" placeholder="Enter User Name" CssClass="form-control" runat="server"></asp:TextBox>


                                    </div>
                                    <div class="input-group m-b">
                                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                        <asp:TextBox ID="txtPassword" required="" placeholder="Enter Password" TextMode="Password" CssClass="form-control" runat="server"></asp:TextBox>                                        
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="col-sm-12 no-padding-left no-padding-right">
                                            <asp:Button ID="btnSignin" class="btn btn-primary block full-width" runat="server" OnClick="btnSignin_Click" Text="Sign In" />
                                        </div>
                                        <div>
                                            <div class="form-group"><asp:LinkButton ID="lnkForgot" CssClass="pull-right" runat="server" OnClick="lnkForgot_Click">Forgot password?</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
