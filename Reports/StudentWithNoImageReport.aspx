<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentWithNoImageReport.aspx.cs" Inherits="SchoolApp.Web.Reports.StudentWithNoImageReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Student With No Image Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <div class="row">
                                ...
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtStName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetsStudents">
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        <label class="col-sm-3" runat="server" for="studentname">Class Name
                                        </label>
                                        <div class="col-sm-9">
                                          <asp:TextBox ID="txtClassname" runat="server" class="form-control" placeholder="Enter Class Name" />
                                        <ajax:autocompleteextender id="Autocompleteextender2" runat="server" targetcontrolid="txtClassname"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetsClasses">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
