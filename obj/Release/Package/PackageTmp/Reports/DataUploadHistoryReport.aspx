<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DataUploadHistoryReport.aspx.cs" Inherits="SchoolApp.Web.Reports.DataUploadHistoryReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Data Upload History Report</span></h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" for="">Template Name:</label>
                                        <div class="col-sm-9">
                                            <asp:DropDownList ID="drpTemplate" runat="server" CssClass="form-control">
                                            <asp:ListItem Value="0" Text="Select Template" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="Student" Text="Student Template"></asp:ListItem>
                                            <asp:ListItem Value="Class" Text="Class Template"></asp:ListItem>
                                            <asp:ListItem Value="Teacher" Text="Teacher Template"></asp:ListItem>
                                        </asp:DropDownList>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="">Template Name:</asp:Label>
                                        <asp:DropDownList ID="drpTemplate" runat="server" CssClass="form-control">
                                            <asp:ListItem Value="0" Text="Select Template" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="Student" Text="Student Template"></asp:ListItem>
                                            <asp:ListItem Value="Class" Text="Class Template"></asp:ListItem>
                                ...
                                <table class="table">
                                    <thead style="background: #232323; color: white;">
                                        <tr>
                                            <th>Date</th>
                                            <th>Template</th>
                                            <th style="text-align:center;">Create Record Count</th>
                                            <th style="text-align:center;">Update Record Count</th>
                                            <th>Uploaded By</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("TemplateName") %></td>
                                                    <td style="text-align:center; border-bottom: 1px solid #ddd !important;"><%# Eval("CreatedCount") %></td>
                                                    <td style="text-align:center; border-bottom: 1px solid #ddd !important;"><%# Eval("UpdatedCount") %></td>
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("SchoolName") %></td>
                                                </tr>
                                            </ItemTemplate>
                                            <LayoutTemplate>
                                                <tr runat="server">
