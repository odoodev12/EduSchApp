<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="SchoolApp.Web.ForgotPassword" %>
        ...
        <ul class="konnect-float-right"><li class="li-last hidden-xs hidden-sm">
          ...
          <li class="dropdown_category"><a href="#" class="customer_login_btn dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user-o" ></i> Login <i class="caret"></i> </a>
		   <ul class="dropdown-menu">
            <li><a href="ForgotPassword.aspx?OP=School">School Login</a></li>
            <li><a href="ForgotPassword.aspx?OP=Teacher">Teacher Login</a></li>
            <li><a href="ForgotPassword.aspx?OP=Parent">Parent Login</a></li>			
          </ul>
		  </li>
  ...
  <div class="container">
    <div class="row">
      <div class="login-main template-form">
        ...
        <center><h3>
            Forgot Password ? </h3></center></div>
        <form runat="server">
          <div class="form-group">
            <label for="inputUsernameEmail">Enter Email</label>
            <asp:TextBox  class="form-control" id="txtUserName" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
          </div>
          <asp:Button runat="server" ID="btnForgot" Text="Send Mail" OnClick="btnForgot_Click" class="btn btn-primary"> </asp:Button>
            <asp:LinkButton ID="lnkLogin" CssClass="pull-right" runat="server" OnClick="lnkLogin_Click">Back to Login</asp:LinkButton>
        </form>
      </div>
    </div>
  </div>
