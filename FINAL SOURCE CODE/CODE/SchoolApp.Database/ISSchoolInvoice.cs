...
namespace SchoolApp.Database
{
    ...
    public partial class ISSchoolInvoice
    {
        ...
        public virtual ISTrasectionStatu ISTrasectionStatu { get; set; }
        public virtual ISTrasectionType ISTrasectionType { get; set; }
    }
}
