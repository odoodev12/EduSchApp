<%@ Page Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Reports1.aspx.cs" Inherits="SchoolApp.Admin.Reports1" %>
                                        ...
                                        <div class="form-horizontal formelement">
                                            ...
                                            <asp:Wizard ID="Wizard1" OnNextButtonClick="Wizard1_NextButtonClick" runat="server" DisplaySideBar="false" Width="100%">
                                                ...
                                                <StartNavigationTemplate>
                                                    <div class="form-group" style="margin-top: 5px">
                                                        <asp:Button ID="Button1" CssClass="btn btn-primary" CausesValidation="true" ValidationGroup="Submit" OnClick="btnSave_Click" runat="server" Text="Save & Next" />&nbsp;&nbsp;
                                                    </div>
                                                </StartNavigationTemplate>
                                                <FinishNavigationTemplate>
                                                    <div class="form-group" style="margin-top: 5px">
                                                        <asp:Button ID="Button2" CssClass="btn btn-default" runat="server" Text="Previous" OnClick="btnReset_Click" />
                                                        <asp:Button ID="Button3" CssClass="btn btn-primary" CausesValidation="true" ValidationGroup="Submit" OnClick="btnSave_Click" runat="server" Text="Save" />&nbsp;&nbsp;
                                                    </div>
                                                </FinishNavigationTemplate>
