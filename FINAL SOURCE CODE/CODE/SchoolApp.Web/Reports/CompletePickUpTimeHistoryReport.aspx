<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CompletePickUpTimeHistoryReport.aspx.cs" Inherits="SchoolApp.Web.Reports.CompletePickUpTimeHistoryReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Complete PickUp Time History</span></h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="Autocompleteextender1" runat="server" targetcontrolid="txtClassName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetClassFuncs">
                                ...
                                <div class="form-horizontal formelement">
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFuncs">
                                        </ajax:autocompleteextender>
                                        </div>
                                    </div>
                            ...
                            <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="classyear">Activated By</asp:Label>
                                        <asp:TextBox ID="txtTeacherName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFuncs">
                                        </ajax:autocompleteextender>
                                        ...
                                        <asp:ListView ID="lstTable" runat="server" OnPagePropertiesChanging="lstTable_PagePropertiesChanging">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: 1px solid #ddd !important;"><%# Eval("CompletePickTime") %></td>
