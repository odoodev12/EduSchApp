<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TeacherAttendanceMarkHistoryReport.aspx.cs" Inherits="SchoolApp.Web.Reports.TeacherAttendanceMarkHistoryReport" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 id="homeHeading">
                            ...
                            / <span>Teacher Attendance Mark History</span></h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="float-e-margins">
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3" for="">Teacher No:</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtTeacherNo" class="form-control" />
                                        </div>
                                    </div>                                   
                                </div>
                            </div>
                                ...
                                <div class="form-horizontal formelement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFunc">
                        ...
                        <div class="row">
                            <%--<div class="col-md-3">
                                <div class="well" id="LargeFiler">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" for="">Teacher No:</asp:Label>
                                        <asp:TextBox runat="server" ID="txtTeacherNo" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <asp:Label for="classyear">Teacher Name</asp:Label>
                                        <asp:TextBox ID="txtTeacherName" runat="server" class="form-control" placeholder="Enter Teacher Name" />
                                        <ajax:autocompleteextender id="AutoCompleteSt" runat="server" targetcontrolid="txtTeacherName"
                                            minimumprefixlength="1" enablecaching="true" completionsetcount="1" completioninterval="1000" servicemethod="GetTeachersFunc">
                                        </ajax:autocompleteextender>
